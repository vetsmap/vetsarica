      ...
      <nav style={{
        ...
        <button
          ...
          style={{
            ...
            padding: '6px 14px',
            borderRadius: '8px',
            border: solo24h ? '1px solid #33511c' : '1px solid #4F772D',
          ...
          <div style={{ overflowY: 'auto', flex: 1 }}>
            {vetsOrdenados.map(vet => {
              ...
              return (
                <div
                  key={vet.id}
                  onClick={() => setVetSeleccionado(seleccionado ? null : vet)}
                  style={{
                    padding: '14px 16px',
                ...
                >
                  <div style={{ display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
                    ...
                    {/* AVATAR — logo si existe, iniciales si no */}
                    <div style={{
                      width: '56px',
                      height: '56px',
                      borderRadius: '14px',
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      <p style={{ fontSize: '11px', color: 'var(--texto2)', marginBottom: '6px', lineHeight: 1.3 }}>
                        {vet.direccion}
                      </p>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                        <span style={{
                          ...
                          <span style={{
                            ...
                            height: '6px',
                            borderRadius: '50%',
                            background: abierto ? '#2d7a3a' : '#b04040',
                            display: 'inline-block',
                          }} />
                        ...
                        {distancia && (
                          <span style={{ fontSize: '11px', color: '#4F772D', fontWeight: 600 }}>
                            📍 {distancia} km
                          </span>
                        )}
                      </div>
                    ...
                    <div style={{ marginTop: '14px', paddingTop: '14px', borderTop: '1px solid var(--borde)' }}>
                      ...
                      {vet.servicios?.length > 0 && (
                        <div style={{ marginBottom: '12px' }}>
                          <p style={{ fontSize: '10px', color: '#33511c', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: '6px', fontWeight: 700 }}>
                            Servicios
                          </p>
                          {vet.servicios.map(s => (
